...
public class StudentForgetPasswordServlet extends HttpServlet implements Servlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			//验证身份
			String pwd=stus.checkForgetPassword(Email, StudentName, Tel);
			
			//发送邮件
			if(pwd==null){
				response.sendRedirect("Back/student-getPasswordFailed.jsp");
			}else{
				//发送邮件
			    ...
			    String password=String.valueOf(pwd);
			        ...
			        */
			        ...
			        //跳转
			        response.sendRedirect("Back/student-getPasswordSuccess.jsp");
			}
