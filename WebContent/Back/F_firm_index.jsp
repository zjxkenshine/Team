...
<body>
<header class="Hui-header cl"> <a class="Hui-logo l" title="H-ui.admin v2.3" href="/">企业管理中心</a> 
	...
	<ul class="Hui-userbar">
		<li>企业：</li>
		<li class="dropDown dropDown_hover"><a href="#" class="dropDown_A">${FirmName} <i class="Hui-iconfont">&#xe6d5;</i></a>
			<ul class="dropDown-menu radius box-shadow">
				<li><a href="#">个人信息</a></li>
				<li><a href="F_firm_login.jsp">切换账户</a></li>
				<li><a href="F_firm_login.jsp">退出</a></li>
			</ul>
		</li>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-system">
			<dt><i class="Hui-iconfont">&#xe62e;</i> 我的二维码<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
