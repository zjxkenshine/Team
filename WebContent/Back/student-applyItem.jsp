...
<body>
<div class="pd-20">
  <form action="../StudentUpdateApply.sdo" method="post" class="form form-horizontal" id="form-member-add">
      <div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>申请项目编号：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text" value="<%=request.getParameter("ID") %>" placeholder="" readonly="readonly" name="ItemID" id="ItemID" datatype="n" ">
      </div>
      <div class="col-4"> </div>
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <textarea name="Descripe" cols="" rows="" class="textarea"  placeholder="介绍一下你自己" datatype="*10-100" dragonfly="true" nullmsg="申请描述不能为空！" onKeyUp="textarealength(this,100)"></textarea>
