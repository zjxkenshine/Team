...
<div class="pd-20">
  <form action="../StudentCreatCheck.sdo" method="post" class="form form-horizontal" id="form-member-add">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
      	<p><input type="hidden" id="url3" name="IdPic"  value=""  datatype="*" nullmsg="请上传身份证照片" /><img src="" width="200px" height="200px" id="img3"><input type="button" id="image3" value="选择图片" /></p>
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-5">
      	<p><input type="hidden" id="url1" name="CreaPic" value=""  datatype="*" nullmsg="请上传大学生创业证照片" /><img width="200px" height="200px" src="" id="img1"><input type="button" id="image1" value="选择图片" /></p>
      </div>
      <div class="col-4"> </div>
    </div>
    <div class="row cl">
