...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 我的消息 <span class="c-gray en">&gt;</span> 系统消息<a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
function del(obj,id){
	...
	window.location.href='../TeacherDeleteMessage.do?ID='+id;
...
$("#prodelete").click(function(){
	layer.msg('已删除!',{icon: 6,time:1000});
		...
		window.location.href='../TeacherDeleteMessage.do?ID='+status;
	});
