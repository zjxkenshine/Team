	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<c:forEach items="${reclist }" var="rec"> 
			<tr class="text-c">
				...
				<td> 
				<a style="text-decoration:none" onClick="collect(this,${rec.getID() })" href="javascript:;" title="收藏"><i class="Hui-iconfont">&#xe603;</i></a>
				<a style="text-decoration:none" onClick="sendresume(this,${rec.getID() })" href="javascript:;" title="投递简历"><i class="Hui-iconfont">&#xe6de;</i></a>
				</td>
