          ...
          <div class="row">          
            <div class="col-md-10 col-md-offset-0">                      
               <div class="about-author">           
                  <img src="img/team-3.jpg" class="img-responsive" alt="" style="width:120px;height:120px;">
                ...
                <c:if test="${student!=null&&(student.getCheckStatus() eq '1'||student.getCheckStatus() eq '0')&&checkresumesend}">
